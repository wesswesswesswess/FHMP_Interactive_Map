...
var format_FHMP_Plots_ALL_cleaned_20241104_5 = new ol.format.GeoJSON();
var features_FHMP_Plots_ALL_cleaned_20241104_5 = format_FHMP_Plots_ALL_cleaned_20241104_5.readFeatures(json_FHMP_Plots_ALL_cleaned_20241104_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_FHMP_Plots_ALL_cleaned_20241104_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_FHMP_Plots_ALL_cleaned_20241104_5.addFeatures(features_FHMP_Plots_ALL_cleaned_20241104_5);
var lyr_FHMP_Plots_ALL_cleaned_20241104_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_FHMP_Plots_ALL_cleaned_20241104_5, 
                style: style_FHMP_Plots_ALL_cleaned_20241104_5,
                popuplayertitle: 'FHMP_Plots_ALL_cleaned_20241104',
                interactive: false,
    title: 'FHMP_Plots_ALL_cleaned_20241104<br />\
    <img src="styles/legend/FHMP_Plots_ALL_cleaned_20241104_5_0.png" /> Jarrah<br />\
    <img src="styles/legend/FHMP_Plots_ALL_cleaned_20241104_5_1.png" /> Karri<br />\
    <img src="styles/legend/FHMP_Plots_ALL_cleaned_20241104_5_2.png" /> Tingle<br />\
    <img src="styles/legend/FHMP_Plots_ALL_cleaned_20241104_5_3.png" /> Wandoo<br />\
    <img src="styles/legend/FHMP_Plots_ALL_cleaned_20241104_5_4.png" /> <br />' });
var format_CornerPosts2025_6 = new ol.format.GeoJSON();
var features_CornerPosts2025_6 = format_CornerPosts2025_6.readFeatures(json_CornerPosts2025_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CornerPosts2025_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CornerPosts2025_6.addFeatures(features_CornerPosts2025_6);
var lyr_CornerPosts2025_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CornerPosts2025_6, 
                style: style_CornerPosts2025_6,
                popuplayertitle: 'Corner Posts 2025',
                interactive: true,
                title: '<img src="styles/legend/CornerPosts2025_6.png" /> Corner Posts 2025'
            });

lyr_GoogleRoads_0.setVisible(true);lyr_GoogleMaps_1.setVisible(true);lyr_TransectEndpoints_2.setVisible(true);lyr_PlotTransects_3.setVisible(true);lyr_Flora2025_4.setVisible(true);lyr_FHMP_Plots_ALL_cleaned_20241104_5.setVisible(true);lyr_CornerPosts2025_6.setVisible(true);
var layersList = [lyr_GoogleRoads_0,lyr_GoogleMaps_1,lyr_TransectEndpoints_2,lyr_PlotTransects_3,lyr_Flora2025_4,lyr_FHMP_Plots_ALL_cleaned_20241104_5,lyr_CornerPosts2025_6];
...
lyr_Flora2025_4.set('fieldImages', {'Filename': 'TextEdit', 'Site': 'TextEdit', 'Corner': 'TextEdit', 'Date': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Larger Image': 'TextEdit', 'Img HTML': 'ExternalResource', });
lyr_FHMP_Plots_ALL_cleaned_20241104_5.set('fieldImages', {'Name': 'TextEdit', 'Code': 'TextEdit', 'Easting': 'TextEdit', 'Northing': 'TextEdit', 'Elevation': 'TextEdit', 'Descriptio': 'TextEdit', 'Longitude': 'TextEdit', 'Latitude': 'TextEdit', 'Ellipsoida': 'TextEdit', 'Origin': 'TextEdit', 'Easting_RM': 'TextEdit', 'Northing_R': 'TextEdit', 'Elevation_': 'TextEdit', 'Lateral_RM': 'TextEdit', 'Antenna_he': 'TextEdit', 'Antenna__1': 'TextEdit', 'Solution_s': 'TextEdit', 'Averaging_': 'TextEdit', 'Averaging1': 'TextEdit', 'Samples': 'TextEdit', 'PDOP': 'TextEdit', 'GDOP': 'TextEdit', 'Base_easti': 'TextEdit', 'Base_north': 'TextEdit', 'Base_eleva': 'TextEdit', 'Base_longi': 'TextEdit', 'Base_latit': 'TextEdit', 'Base_ellip': 'TextEdit', 'Baseline': 'TextEdit', 'Mount_poin': 'TextEdit', 'CS_name': 'TextEdit', 'GPS_Satell': 'TextEdit', 'GLONASS_Sa': 'TextEdit', 'Galileo_Sa': 'TextEdit', 'BeiDou_Sat': 'TextEdit', 'QZSS_Satel': 'TextEdit', 'Site_ID': 'TextEdit', 'PlotName': 'TextEdit', 'forest_typ': 'TextEdit', 'Lat d.m': 'TextEdit', 'Long d.m': 'TextEdit', });
lyr_CornerPosts2025_6.set('fieldImages', {'filename': 'TextEdit', 'Site': 'TextEdit', 'Corner': 'TextEdit', 'Date': 'TextEdit', 'Longitude': 'TextEdit', 'Latitude': 'TextEdit', 'Larger Image': 'TextEdit', 'Img HTML': 'ExternalResource', 'RawGithub': 'TextEdit', });
